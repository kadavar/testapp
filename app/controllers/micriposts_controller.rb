class MicripostsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @micripost.save
        ...
        format.json { render :show, status: :created, location: @micripost }
      else
  ...
  def update
    respond_to do |format|
      if @micripost.update(micripost_params)
        ...
        format.json { render :show, status: :ok, location: @micripost }
      else
  ...
  def destroy
    @micripost.destroy
    respond_to do |format|
      format.html { redirect_to micriposts_url, notice: 'Micripost was successfully destroyed.' }
  ...
  private
    ...
    def micripost_params
      params.require(:micripost).permit(:content, :user_id)
    end
end
